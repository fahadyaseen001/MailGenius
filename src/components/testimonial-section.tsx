  ...
  return (
    ...
    >
      ...
      <div className="pt-5 text-center">
        <div className="inline-block bg-white px-8 py-2 rounded-full mb-10">
        ...
        <div className="max-w-[900px] mx-auto px-4 relative">
          <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-1 leading-tight tracking-tight whitespace-nowrap">
            {isVisible && (
              <AnimatedNumber 
                value={57278} 
          ...
          <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-24 md:mb-20 leading-tight tracking-tight">
            generated
          </h2>
          <div 
